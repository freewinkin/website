...
const Icon = {
  ...
  radar: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 3 18 18M21 3 3 21" /></svg>
  ),
  trophy: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 21h8M12 17v4M7 4h10v4a5 5 0 0 1-10 0V4Z" /><path d="M17 5h3a2 2 0 0 1-2 4M7 5H4a2 2 0 0 0 2 4" /></svg>
  ),
  checklist: (
  ...
  crown: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m2 8 4 3 6-7 6 7 4-3-2 11H4L2 8Z" /></svg>
  ),
  lock: (
  ...
  home: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z" /></svg>
  ),
  search: (
...
export default function StartupBrief({ data, onBack }: StartupBriefProps) {
  ...
  const navItems = [
    ...
    { label: "Competitors", icon: Icon.users, active: false },
  ...
  const advantages = [
    { icon: Icon.sparkle, label: "AI-native workflow", sub: "Built for speed and automation", value: 92 },
    { icon: Icon.rocket, label: "Faster research", sub: "Deliver insights in minutes", value: 88 },
    { icon: Icon.chat, label: "Founder-first approach", sub: "Solving real founder problems", value: 85 },
  ];
  ...
  const proFeatures = [
    { icon: Icon.chat, title: "AI Strategy Chat", desc: "Ask anything. Get expert answers." },
    { icon: Icon.matrix, title: "Full Competitor SWOT Matrix", desc: "Feature comparisons, traffic data, positioning gaps & more." },
    { icon: Icon.users, title: "Customer Deep Dive", desc: "Personas, JTBD, channels, and synthetic interviews." },
    { icon: Icon.finance, title: "Dynamic Financials", desc: "Adjust forecasts, pricing scenarios & break-even analysis." },
    { icon: Icon.monitor, title: "Market Monitoring", desc: "Weekly updates, trend alerts & competitor tracking." },
    { icon: Icon.doc, title: "Export Suite", desc: "PDF reports, slide decks, CSV, and more." },
  ];

  const footerNav = ["Market Research", "Competitors", "Customers", "Go-to-Market", "Tasks", "Documents"];
      ...
      <div className="sb-shell">
        ...
        <aside className="sb-sidebar">
          <div className="sb-sidebar-top">
            ...
            <div className="sb-workspace">
              ...
              <div className="sb-workspace-text">
                ...
                <p className="sb-workspace-sub">AI Market Research Platform</p>
              </div>
          ...
          <div className="sb-sidebar-bottom">
            ...
            <div className="sb-upgrade-card">
              <p className="sb-upgrade-title">Unlock everything with Xvora Pro</p>
              <p className="sb-upgrade-sub">Get full competitive intel, deep research, exports, and AI strategy chat.</p>
        ...
        <main className="sb-main">
          ...
          <section className="sb-card">
            <div className="sb-section-head">
              <div className="sb-section-title">
                <span className="sb-section-icon">{Icon.clock}</span>
                1. Executive Summary
              </div>
              <span className="sb-badge sb-badge-green">Updated live</span>
            </div>

            <div className="sb-exec-top">
              <div className="sb-grade-block">
                <p className="sb-block-label">Overall Grade</p>
                <div className="sb-grade">A-</div>
                <p className="sb-grade-title">Strong traction potential</p>
            ...
            <div className="sb-market-section">
              <div className="sb-market-bars">
                ...
                <div className="sb-market-row">
                  ...
                  <div className="sb-market-figures">
                    ...
                    <span className="sb-market-note">13% of TAM · Your addressable market</span>
                  </div>
                </div>
                <div className="sb-market-row">
              ...
              <div className="sb-donut-wrap">
                <svg viewBox="0 0 120 120" className="sb-donut">
                  <circle cx="60" cy="60" r="50" fill="none" stroke="#ece9fd" strokeWidth="16" />
                  <circle
                    cx="60" cy="60" r="50" fill="none" stroke="#403690" strokeWidth="16"
                    strokeDasharray="314.159" strokeDashoffset="235.6"
                    strokeLinecap="round" transform="rotate(-90 60 60)"
                  />
                </svg>
                <div className="sb-donut-center">
                  <span className="sb-donut-value">$18.2B</span>
                  <span className="sb-donut-label">TAM</span>
                </div>
              </div>
            </div>
          ...
          <section className="sb-card">
            <div className="sb-section-head">
              <div className="sb-section-title">
                <span className="sb-section-icon">{Icon.radar}</span>
                2. Competitor &amp; Risk Radar
              </div>
              <span className="sb-badge sb-badge-amber">Moderate saturation</span>
            </div>

            <div className="sb-radar-grid">
              <div className="sb-radar-left">
                <div className="sb-competition-top">
                  <span className="sb-block-label" style={{ marginBottom: 0 }}>Market Density</span>
                  <span className="sb-competition-pct">68% · Competitive</span>
                </div>
                <div className="sb-bar-track">
                  <div className="sb-bar-fill sb-bar-fill-amber" style={{ width: "68%" }} />
                </div>
                ...
                <p className="sb-block-label sb-mt-24">Direct Competitors</p>
                <div className="sb-pills">
                  <span className="sb-pill"><strong>Forrester</strong> · Enterprise</span>
                  <span className="sb-pill"><strong>CB Insights</strong> · Data-heavy</span>
                  <span className="sb-pill">+3 niche players</span>
                </div>
              </div>

              <div className="sb-radar-right">
                <p className="sb-block-label">Top Risks (Actionable)</p>
          ...
          <section className="sb-card">
            <div className="sb-section-head">
              <div className="sb-section-title">
                <span className="sb-section-icon">{Icon.trophy}</span>
                3. Why You Can Win
              </div>
            </div>
              ...
              <div className="sb-advantages">
                {advantages.map((a) => (
                  <div className="sb-advantage-row" key={a.label}>
                    ...
                    <span className="sb-advantage-value">{a.value}%</span>
                  </div>
                ))}
              </div>
            ...
            <a className="sb-view-link" href="#">View full advantage breakdown {Icon.arrowRight}</a>
          </section>
          ...
          <section className="sb-card">
            <div className="sb-section-head">
              <div className="sb-section-title">
                <span className="sb-section-icon">{Icon.checklist}</span>
            ...
            <div className="sb-steps-grid">
              ...
              <div className="sb-immediate-box">
                <p className="sb-immediate-title">Top 3 Immediate Actions</p>
          ...
          <div className="sb-bottom-cta">
            <div>
              <p className="sb-bottom-cta-title">{Icon.sparkle} Want the full deep-dive research?</p>
              <p className="sb-bottom-cta-sub">Unlock 40+ pages of deep research, data sources, and expert insights.</p>
            </div>
            <button className="sb-btn-secondary sb-bottom-cta-btn">
              View Full Research Suite {Icon.arrowRight}
            </button>
          </div>
        </main>
        ...
        <aside className="sb-right">
          <div className="sb-right-card">
            <div className="sb-right-crown">{Icon.crown}</div>
            <p className="sb-right-title">Unlock your full startup strategy</p>
            <p className="sb-right-sub">
              Upgrade to Xvora Pro to get the complete research suite and actionable recommendations.
            </p>

            <ul className="sb-pro-list">
              {proFeatures.map((f) => (
                <li key={f.title}>
                  <span className="sb-pro-icon">{f.icon}</span>
                  <div>
                    <p className="sb-pro-title">{f.title}</p>
                    <p className="sb-pro-desc">{f.desc}</p>
                  </div>
                </li>
              ))}
            </ul>

            <button className="sb-btn-primary sb-btn-full">
              {Icon.rocket}
              <span>
                Upgrade to Pro
                <span className="sb-btn-sub">Unlock Competitor SWOT &amp; Export</span>
              </span>
            </button>
            <button className="sb-btn-secondary sb-btn-full">View Pro Features</button>
            <p className="sb-right-note">{Icon.lock} Cancel anytime</p>
          </div>
        </aside>
      </div>

      <footer className="sb-footer">
        <span>© 2026 Xvora · AI Intelligence for Founders</span>
