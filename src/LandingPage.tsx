...
export default function XvoraLanding({ onAnalyze }: XvoraLandingProps) {
  ...
  useEffect(() => {
    ...
    fontLink.id = 'xvora-fonts';
    fontLink.rel = 'stylesheet';
    fontLink.href =
      'https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700;800&family=Kalam:wght@400;700&display=swap';
    ...
    <div className="xvora-page">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <button className="btn-primary" onClick={handleAnalyzeClick}>Analyze My Startup</button>
          ...
          <div className="diagram-canvas">
            ...
            <div className="node node-idea">
              <div className="icon-wrap">
                <svg viewBox="0 0 24 24" fill="none" stroke="#403690" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"/><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>
              </div>
            ...
            <div className="node node-market">
              <div className="icon-wrap market">
                <svg viewBox="0 0 24 24" fill="none" stroke="#403690" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
              </div>
            ...
            <div className="node node-competitor">
              <div className="icon-wrap competitor">
                <svg viewBox="0 0 24 24" fill="none" stroke="#403690" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
              </div>
            ...
            <div className="node node-opportunities">
              <div className="icon-wrap opportunities">
                <svg viewBox="0 0 24 24" fill="none" stroke="#403690" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 14c.2-1 .7-1.7 1.5-2.5A5.5 5.5 0 1 0 8.5 11.5c.8.8 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>
              </div>
            ...
            <div className="node node-nextsteps">
              <div className="icon-wrap nextsteps">
                <svg viewBox="0 0 24 24" fill="none" stroke="#403690" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>
              </div>
      ...
      <section className="features">
        ...
        <div className="feature-row">
          ...
          <div className="feature-visual">
            <div className="sticky-note" style={{ '--tilt': '-2deg' } as React.CSSProperties}>
        ...
        <div className="feature-row">
          ...
          <div className="feature-visual">
            <div className="sticky-note" style={{ '--tilt': '-1.5deg' } as React.CSSProperties}>
              <span className="tape"></span>
          ...
          <div className="feature-visual">
            <div className="sticky-note" style={{ '--tilt': '1.5deg' } as React.CSSProperties}>
              ...
              <svg className="doodle" viewBox="0 0 260 60" fill="none" stroke="#1a1a1a" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <path d="M38 30 h24" markerEnd="url(#a)"/>
      ...
      <section>
        <div className="cta-band">
          ...
          <button className="btn-primary" onClick={handleAnalyzeClick}>Analyze My Startup &rarr;</button>
        </div>
      </section>
