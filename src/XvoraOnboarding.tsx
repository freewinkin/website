        ...
        <div className="flex-1 h-full overflow-y-auto px-16 py-12 flex flex-col justify-between">
          <div className="max-w-[850px] w-full mx-auto">
            <AnimatePresence mode="wait">
                  ...
                  <div className="mt-10 space-y-6">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type="text" value={startupName} onChange={(e) => setStartupName(e.target.value)} placeholder="e.g. Xvora" className="w-full pl-10 pr-4 py-2.5 bg-white border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-[#6366F1] focus:ring-1 focus:ring-[#6366F1]" />
                      </div>
                    </div>
              ...
              {/* STEP 2 - INCLUDES FULL UPLOAD SECTION */}
              {currentStep === 2 && (
                <motion.div key="step2" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.25 }} className="w-full">
                  ...
                  <div className="mt-8 space-y-6">
                    <div>
                      ...
                      <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="We're building an AI platform that helps founders validate startup ideas..." className="w-full h-[220px] p-4 bg-white border border-neutral-200 rounded-xl text-sm text-neutral-900 focus:outline-none focus:border-[#6366F1] resize-none" />
                    </div>
                    ...
                    <div className="border border-dashed border-neutral-300 rounded-2xl p-6 bg-white flex items-center justify-between">
                      <div className="flex items-start gap-4">
                        <div className="p-3 bg-indigo-50 text-[#6366F1] rounded-xl shrink-0"><Upload className="w-5 h-5" /></div>
                        <div>
                      ...
                      <button type="button" className="px-4 py-2 border border-neutral-200 hover:border-[#6366F1] text-[#6366F1] text-xs font-semibold rounded-xl shadow-sm shrink-0 flex items-center gap-2 bg-white cursor-pointer">
                        <Upload className="w-3.5 h-3.5" /> Upload Startup Document
                      </button>
                    </div>
                  </div>
                </motion.div>
